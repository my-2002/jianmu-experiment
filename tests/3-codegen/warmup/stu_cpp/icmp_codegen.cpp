...
void translate_main(CodeGen *codegen) {
    ...
    codegen->append_inst("st.d",{"$t2", "$fp", std::to_string(offset_map["%op1"])});
    ...
    codegen->append_inst("slt $t0, $zero, $t2");
    codegen->append_inst("st.d",{"$t0", "$fp", std::to_string(offset_map["%op2"])});
    ...
    codegen->append_inst("ld.d",{"$t0", "$fp", std::to_string(offset_map["%op2"])});
