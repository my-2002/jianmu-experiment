...
label_loop1:                                                ; preds = %label_condition0
  ...
  %op29 = icmp slt i32 %op24, zeroinitializer
...
label_b_gtz4:                                                ; preds = %label_loop1, %label_b_ltz3
  ...
  %op39 = mul i32 59, %op25
  %op40 = add i32 %op39, %op24
  %op41 = getelementptr i32, i32* %op38, i32 %op40
  %op42 = load i32, i32* %op41
  call void @putint(i32 %op42)
  %op43 = load i32, i32* %op18
  %op44 = add i32 %op43, 1
  store i32 %op44, i32* %op18
  br label %label_condition0
label_d_ltz5:                                                ; preds = %label_ret2
  call void @neg_idx_except()
  br label %label_d_gtz6
label_d_gtz6:                                                ; preds = %label_ret2, %label_d_ltz5
  %op45 = load i32*, i32** %op12
  %op46 = getelementptr i32, i32* %op45, i32 %op33
...
label_condition7:                                                ; preds = %label_d_gtz6, %label_g_gtz11
  ...
  %op49 = add i32 %op48, 10
  %op50 = icmp slt i32 %op48, 10
  %op51 = zext i1 %op50 to i32
  %op52 = icmp sgt i32 %op51, zeroinitializer
  br i1 %op52, label %label_loop8, label %label_ret9
label_loop8:                                                ; preds = %label_condition7
  %op53 = load i32, i32* %op17
  ...
  br i1 %op57, label %label_g_ltz10, label %label_g_gtz11
label_ret9:                                                ; preds = %label_condition7
  %op58 = load i32, i32* %op13
  %op59 = load i32, i32* %op14
...
label_g_gtz11:                                                ; preds = %label_loop8, %label_g_ltz10
  %op61 = load i32*, i32** %op15
  %op62 = getelementptr i32, i32* %op61, i32 %op53
  %op63 = load i32, i32* %op16
  %op64 = mul i32 %op63, 128875
  %op65 = sdiv i32 %op64, 3724
  %op66 = mul i32 %op65, 3724
  %op67 = sub i32 %op64, %op66
  store i32 %op67, i32* %op62
  %op68 = load i32, i32* %op17
  %op69 = add i32 %op68, 1
  store i32 %op69, i32* %op17
  %op70 = load i32, i32* %op16
  %op71 = add i32 %op70, 7
  store i32 %op71, i32* %op16
  br label %label_condition7
}
define i32 @main() {
label_entry:
...
label_b_gtz29:                                                ; preds = %label_b_gtz27, %label_b_ltz28
  ...
  %op74 = alloca i32
  %op75 = icmp slt i32 17, zeroinitializer
  %op76 = zext i1 %op75 to i32
  %op77 = add i32 %op76, zeroinitializer
  %op78 = icmp slt i32 1, zeroinitializer
...
label_a_gtz33:                                                ; preds = %label_a_gtz31, %label_a_ltz32
  %op92 = getelementptr [61 x [67 x i32]], [61 x [67 x i32]]* %op0, i32 0, i32 17, i32 3
...
label_a_gtz35:                                                ; preds = %label_a_gtz33, %label_a_ltz34
  ...
  %op100 = icmp slt i32 6, zeroinitializer
  %op101 = zext i1 %op100 to i32
  %op102 = add i32 %op101, zeroinitializer
  %op103 = icmp slt i32 3, zeroinitializer
...
label_b_gtz37:                                                ; preds = %label_a_gtz35, %label_b_ltz36
  %op107 = getelementptr [53 x [59 x i32]], [53 x [59 x i32]]* %op1, i32 0, i32 6, i32 3
  %op108 = load i32, i32* %op107
  %op109 = icmp slt i32 6, zeroinitializer
  %op110 = zext i1 %op109 to i32
  %op111 = add i32 %op110, zeroinitializer
  %op112 = icmp slt i32 0, zeroinitializer
...
label_b_gtz39:                                                ; preds = %label_b_gtz37, %label_b_ltz38
  %op116 = getelementptr [53 x [59 x i32]], [53 x [59 x i32]]* %op1, i32 0, i32 6, i32 0
...
label_b_gtz41:                                                ; preds = %label_b_gtz39, %label_b_ltz40
  ...
  %op124 = icmp slt i32 34, zeroinitializer
  %op125 = zext i1 %op124 to i32
  %op126 = add i32 %op125, zeroinitializer
  %op127 = icmp slt i32 4, zeroinitializer
...
label_b_gtz43:                                                ; preds = %label_b_gtz41, %label_b_ltz42
  %op131 = getelementptr [53 x [59 x i32]], [53 x [59 x i32]]* %op1, i32 0, i32 34, i32 4
  %op132 = load i32, i32* %op131
  %op133 = icmp slt i32 51, zeroinitializer
  %op134 = zext i1 %op133 to i32
  %op135 = add i32 %op134, zeroinitializer
  %op136 = icmp slt i32 18, zeroinitializer
...
label_b_gtz45:                                                ; preds = %label_b_gtz43, %label_b_ltz44
  %op140 = getelementptr [53 x [59 x i32]], [53 x [59 x i32]]* %op1, i32 0, i32 51, i32 18
...
label_loop47:                                                ; preds = %label_condition46
  ...
  %op150 = icmp slt i32 6, zeroinitializer
  %op151 = zext i1 %op150 to i32
  %op152 = add i32 %op151, zeroinitializer
  %op153 = icmp slt i32 %op149, zeroinitializer
...
label_b_gtz50:                                                ; preds = %label_loop47, %label_b_ltz49
  %op157 = getelementptr [53 x [59 x i32]], [53 x [59 x i32]]* %op1, i32 0, i32 6, i32 %op149
